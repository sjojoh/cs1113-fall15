...
set_member v (mkSet (h::t)) = ite (eql v h) 
                              (true)
                              (set_member v (mkSet t)) 
...
combine (h::t) l1 = ite (member h l1)
                    (combine  t l1)
                    (h::(combine t l1))  
   
    

set_union (mkSet la) (mkSet lb) = (mkSet (combine la lb)) 
-------------------------------------
...
-- sets {1, 2} and {a, b} is { (1, a), (1, b), (2, a), (2, b) }.
-- set_product: (s1: set a) -> (s2: set b) -> set (pair a b)
-- pair elt takse an elt h and a list b returns a list of all pairs,
...
--given a list a and a list of b return a list of all a-b pairs 
...
-- we already did.
--set_eql: set a -> set a -> set a 
--set_eql la lb = eql (mkSet la) (mkSet lb) 
...
--sublist2 h::t = (h::t)++(h::(sublist2 t)) 



--set_toString: (Serialize a) => set a -> String 
--set_toString (mkSet nil) = "{}"
--set_toString (mkSet (h::t)) = "{"++"{}"++

set_append: a -> set a -> set a 
set_append h (mkSet l) = mkSet (h::l) 

list_append: a -> list (set a) -> list (set a) 
list_append v nil = (mkSet (v::nil))::nil
list_append v (h::t) = (set_append v h)::(list_append v t) 

list_powerset: list a -> list (set a) 
list_powerset nil = nil 
list_powerset (h::t) = (list_append h (list_powerset t))++(list_powerset t) 

set_powerset (mkSet l) = mkSet (list_powerset l) 

set_toString: (Serialize a) => set a -> String 
set_toString (mkSet nil) = "{}"
set_toString (mkSet (h::t)) = "{"++"{}"++"{set_powerset (mkSet l)} 
"++"}" 
